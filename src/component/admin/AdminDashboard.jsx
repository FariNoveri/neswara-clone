            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 animate-slideUp">
              ...
              <div className="space-y-3">
                {news.slice(0, 5).map((item, index) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-200 transform hover:scale-[1.01] animate-fadeInUp"
                  ...
                  >
                    <div className="flex-1 flex items-center space-x-4">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900 max-w-xs truncate">{item.judul}</h4>
