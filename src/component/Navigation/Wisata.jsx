    ...
    const fetchNews = async () => {
      ...
      try {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
          ...
          console.error("Firestore onSnapshot error (Wisata):", {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="no-news-container text-center py-12">
          ...
          <p className="text-gray-500">Belum ada berita untuk kategori Wisata. Silakan cek kembali nanti!</p>
        </div>
      ) : (
